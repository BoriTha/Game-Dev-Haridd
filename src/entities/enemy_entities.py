...
from src.core.utils import los_clear, find_intermediate_visible_point, find_idle_patrol_target, resource_path
...
class Enemy:
    ...
    def load_sprite_system(self, idle_path, sprite_size=(96, 128), offset_y=55):
        ...
        """
        try:
            img = pygame.image.load(resource_path(idle_path)).convert_alpha()
    ...
    def load_projectile_sprite(self, sprite_path, sprite_size=(42, 42)):
        ...
        """
        try:
            sprite_img = pygame.image.load(resource_path(sprite_path)).convert_alpha()
...
class Golem(Enemy):
    ...
    def __init__(self, x, ground_y):
        ...
        # Load idle sprite
        try:
            img = pygame.image.load(resource_path("assets/monster/Dark_Knight.png")).convert_alpha()
        ...
        # ----------------------------
        try:
            aura_img = pygame.image.load(resource_path("assets/monster/atk/Dark_Knight_Aura.png")).convert_alpha()
